...
public enum ErrorCode {
    ...
    INVALID_USERNAME(HttpStatus.BAD_REQUEST, "USER-005", "유효하지 않은 이름입니다."),
    HAS_EMAIL(HttpStatus.CONFLICT, "USER-006", "이미 가입된 이메일입니다."),
    INVALID_EMAIL(HttpStatus.BAD_REQUEST, "USER-007", "유효하지 않은 이메일입니다."),
    EXPIRED_EMAIL(HttpStatus.BAD_REQUEST, "USER-008", "만료된 이메일입니다."),
    EMAIL_NOT_VERIFIED(HttpStatus.BAD_REQUEST, "USER-009", "인증되지 않은 이메일입니다."),
    UNABLE_TO_SEND_EMAIL(HttpStatus.BAD_REQUEST, "USER-010", "이메일 인증을 실패했습니다."),
